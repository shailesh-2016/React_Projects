  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        {/* <li>
          <NavLink className="nav-link active" aria-current="page" to="/counter">Counter</NavLink>
        </li> */}
        ...
        <li>
          <NavLink className="nav-link active" aria-current="page" to="/View">ViewRedux</NavLink>
        </li>
        <li>
          <NavLink className="nav-link active" aria-current="page" to="/UpdateRedux/:id">UpdateRedux</NavLink>
        </li>
